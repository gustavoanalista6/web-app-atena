...
export default function Home() {
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (author) {
        author.style.transform = `translateX(${mouseX * 20 - 10}px) translateY(${mouseY * 20 - 10}px)`;
      }
    };
  ...
  const handleChatClick = () => {
    let iframe = document.getElementById("chatbotIframe") as HTMLIFrameElement;
  ...
  return (
    <>
      ...
      <main>
        <h1>Conheça Atena</h1>
        <h2>Sua Nova Tutora 24 Horas! Educação do futuro, hoje.</h2>
      ...
      <footer>
        <div className="footer-content">
          ...
          <div className="social-icons">
            <a href="https://wa.me/5536723737" target="_blank" className="social-icon whatsapp-icon" title="WhatsApp">
              {/* SVG WhatsApp */}
            </a>
            <a href="https://uniatenas.apprbs.com.br/iniciar-inscricao" target="_blank" className="social-icon vestibular-icon" title="Vestibular 2025">
              {/* SVG Vestibular */}
            </a>
            <a href="https://www.instagram.com/colegioatenasoficial" target="_blank" className="social-icon instagram-icon" title="Instagram">
              {/* SVG Instagram */}
            </a>
          </div>
        </div>
